...
#> [1] betaSandwich_1.0.8.9000
#> 
#> loaded via a namespace (and not attached):
#> [1] compiler_4.5.2  cli_3.6.5.9000  tools_4.5.2     otel_0.2.0     
#> [5] rProject_0.0.25 knitr_1.51      xfun_0.56       rlang_1.1.7    
#> [9] evaluate_1.0.5
```
...
#>                   Package             Version     
#> betaSandwich      "betaSandwich"      "1.0.8.9000"
#> abind             "abind"             "1.4-8"     
#> Amelia            "Amelia"            "1.8.3"     
#> arm               "arm"               "1.14-4"    
...
## Memory
    ...
    #> Mem:            23Gi       4.1Gi       7.2Gi        87Mi        12Gi        19Gi
    #> Swap:           11Gi       5.0Mi        11Gi
    #> Total:          34Gi       4.1Gi        18Gi
